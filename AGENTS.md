...
- AIS comes from AISStream (WebSocket); cron listens ~45s each minute, coasts moving tracks for 10 minutes, and shows moving vessels only (default min SOG 0.5 kn).
